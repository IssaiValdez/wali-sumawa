...
export function ModalConfiguracion({ mostrar, onCerrar }: ModalConfiguracionProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] backdrop-blur-sm">
      <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto p-6 shadow-2xl border-2 border-slate-300">
